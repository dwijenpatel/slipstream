...
| --- | --- | --- | --- | --- |
| Expert-cache slots | 8, 16, 24, 32, 48, 64, 96, 128, 192, 256 | `--expert-cache-slots` | 64 | Routed experts retained per layer. Memory cost is slots times layers times the expert stride, about 71 MiB per slot step on Qwen3.6 and 101 MiB on Gemma 4. On the 24 GB M5 host, the 2026-09-06 sweep at a 3k prompt measured 27.1 tokens per second at 16 slots, 31.1 at 64, 31.9 at 128, and 25.2 at 192: past about 128 the cache evicts the file pages that were absorbing its own misses. Re-measure on other hosts. |
